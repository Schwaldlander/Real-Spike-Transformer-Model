...
parser.add_argument('-rssf_root', type=str, default="/home/RSSF")#/home/data/rzhao/rssf")
parser.add_argument( '--dataset', type=str, default='rssf')
parser.add_argument( '--img_size_config', type=str, default='img_size.json')
parser.add_argument('--flipud', action='store_true', help='Flip the raw spike')
...
if __name__ == '__main__':
    ...
    for kk in range(1,len(scenario_list)):
